...
<form action="/adminUpdateFilm?id=<?=$film['id']?>" method="POST" enctype="multipart/form-data"> 
...
"><label for="fname">Название *:</label></td>
  <td><input type="text" id="fname" name="name" value="<?=$film['name']?>"></td><br><br>
</tr>
<tr>
  <td ><label for="description">Описание *:</label></td>
  <td><textarea rows="5" type="text" id="description" name="description"><?=$film['description']?></textarea></td><br><br>
</tr>
